  ...
  describe("FileSystemDirectoryHandle", () => {
    ...
    describe("getDirectoryHandle", () => {
      ...
      it<Context>(
        ...
        async function () {
          const handle = await this.root.getDirectoryHandle(
            "non-existing-dir",
            {
              create: true,
            },
      ...
      it<Context>(
        ...
        async function () {
          ...
          for (const separator of pathSeparators) {
            ...
            await expect(
              this.root.getDirectoryHandle(path_with_separator, {
                create: true,
              }),
            )
              .rejects
    ...
    describe("resolve", () => {
      ...
      it<Context>(
        ...
        async function () {
          ...
          const file = await subdir.getFileHandle("file-name", {
            create: true,
          });
    ...
    describe("removeEntry", () => {
      ...
      it<Context>(
        ...
        async function () {
          ...
          for (const pathSeparator of pathSeparators) {
            const path_with_separator =
              `${dir_name}${pathSeparator}${file_name}`;
      ...
      it<Context>(
        ...
        async function () {
          ...
          await expect(handle.createWritable({ keepExistingData: true }))
            .rejects
            .toThrow(
              DOMException,
            );
